...
const TRANSLATIONS = {
  ko: {
    ...
    candidateCopy: "영상에서 대표 인물 최대 5명을 찾은 뒤, 블러에서 제외할 인물만 선택하세요.",
  ...
  en: {
    ...
    candidateCopy: "Find up to five representative people, then select only the people to exclude from blur.",
