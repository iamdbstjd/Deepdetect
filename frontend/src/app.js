...
const TRANSLATIONS = {
  ko: {
    ...
    selectedCharacterCopy: "참조 인물 얼굴 위치에 이모지를 원본 비율로 안정적으로 합성합니다.",
    startProcess: "처리 시작",
    ...
    processedPlaceholderCopy: "세션 생성 후 블러/캐릭터 결과가 표시됩니다.",
    createSession: "세션 생성",
    startCamera: "카메라 시작",
    stopCamera: "카메라 중지",
  ...
  en: {
    ...
    heroLede: "Detect faces and license plates, then preserve the reference person or replace them with an emoji.",
    metricDetection: "sample face detections",
    metricBlur: "average sharpness reduction",
    metricLanguage: "language toggle",
    showcaseBadge: "Real sample output",
    showcaseBlurTitle: "Face blur result",
    showcasePreserveTitle: "Reference preserved",
    showcaseEmojiTitle: "Emoji replacement",
    showcaseBlur: "Blur",
    showcasePreserve: "Preserve",
    showcaseEmoji: "Emoji",
    ...
    selectedCharacterCopy: "Attach the emoji at the reference face position without stretching the asset.",
    ...
    processedPlaceholderCopy: "Create a session to see blur or character output.",
